...
# 小云来订单: 业务太好  , 我将我的流水线 按照第一条 全  部复制几条在旁边  : 多进程
...
def downloader(img_name, img_url):
    print(1,gevent.getcurrent())
    req = urllib.request.urlopen(img_url) #传入需要下载文件的路径
    print(2,gevent.getcurrent())
    img_countent = req.read()
    print(3,gevent.getcurrent())
    with open(img_name,"wb") as f:
        print(4,gevent.getcurrent())
        f.write(img_countent)

def main():
    gevent.joinall([
          gevent.spawn(downloader,"1.jpg", "http://k.zol-img.com.cn/sjbbs/7692/a7691515_s.jpg")
