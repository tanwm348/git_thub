...
def vipxz():
    ...
    driver.find_element_by_id("childsex").click()
    driver.find_element_by_xpath("/html/body/div[4]/div[1]/form[1]/div[6]/select/option[2]").click()#选择女
